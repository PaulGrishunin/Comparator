...
class OtomotorSpider(scrapy.Spider):
    ...
    start_urls = ['https://www.otomoto.pl/osobowe/?search%5Border%5D=created_at_first%3Adesc&search%5Bbrand_program_id%5D%5B0%5D=&search%5Bcountry%5D=&page='+'%s' % page for page in range(1,15)]
